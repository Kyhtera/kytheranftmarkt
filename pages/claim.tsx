...
function Home() {
  ...
  console.log(
    Number(activeClaimCondition?.data?.currencyMetadata.displayValue)
  );
      ...
      <main className={styles.mintInfoContainer}>
        ...
        <div className={styles.rightSide}>
          <div className={styles.mintCompletionArea}>
            <div className={styles.mintAreaLeft}>Total Minted</div>
            ...
            <div>
              ...
              <div className={styles.quantityContainer}>
                ...
                <button
                  ...
                  disabled={
                    quantity >=
                    Number(activeClaimCondition?.data?.maxClaimablePerWallet)
                  }
                >
                  +
                </button>
